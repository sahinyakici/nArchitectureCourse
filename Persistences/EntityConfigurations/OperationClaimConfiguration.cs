...
public class OperationClaimConfiguration : IEntityTypeConfiguration<OperationClaim>
{
    ...
    //
    //         IEnumerable<Type> featureOperationClaimTypes =
    //             Assembly.GetAssembly(typeof(ApplicationServiceRegistration)).GetTypes().Where(
    //                 type => (type.Namespace?.Contains("Features") == true) &&
    //                         (type.Namespace?.Contains("Constants") == true) && (type.IsClass) &&
    //                         (type.Name.EndsWith("OperationClaims")));
    //
    //         foreach (Type type in featureOperationClaimTypes)
    //         {
